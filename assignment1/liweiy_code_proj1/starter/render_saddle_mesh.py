...
Usage:
    python -m starter.render_saddle_mesh
"""
...
def render_saddle_mesh(image_size=256, voxel_size=64, device=None):
    ...
    num_views = 36
    R, T = pytorch3d.renderer.look_at_view_transform(5, 0, np.linspace(-180, 180, num_views, endpoint=False))
...
if __name__ == "__main__":
    ...
    imageio.mimsave('images/saddle_mesh.gif', images, duration=1000//15, loop=0)
